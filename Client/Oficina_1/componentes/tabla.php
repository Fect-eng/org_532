...
<div class="row">
	...
	<h3></h3>
		<table class="table table-hover table-condensed table-bordered custom-table">
			<!-- <caption>

			http://localhost/juego_login/Admin/navigation/navigator.php#
