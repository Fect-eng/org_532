...
<!-- este boton es de la parte debajo del nav de navegacion, podras crear nuevo usuario si se requiere 
     ...
     <div class="centered-div">
        <h2>GERENCIA DE INFRAESTRUCTURA Y DESARROLLO URBANO</h2>
        <h3>Sub Gerencia de Desarrollo Urbano-Rural y Gestion de Riesgos de Desastres</h3>
        <h3>EF GESTION DE RIESGOS Y DESASTRES</h3>
</div>
