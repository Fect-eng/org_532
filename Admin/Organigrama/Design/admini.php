 ...
 <!-- Contenido de la página -->
    ...
    <div class="container-fluid">
        <div class="text-center mb-4">
            <h3 id="TituloPrimary" class="text-dark">GERENCIA DE  ADMINISTRACION - Municipalidad Ciudad Nueva</h3>
        </div>
    </div>
    <div id="arbol"></div>
    </div>
    ...
    var datosEstaticos = [
        { id: 1, nombres: "GERENCIA DE  ADMINISTRACION", gerencia: "Municipalidad Ciudad Nueva" },
        { id: 2, nombres: "Sub Gerencia de Gestion de Recursos Humanos", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 1 },
        { id: 3, nombres: "Sub Gerencia de Contabilidad", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 1 },
        { id: 4, nombres: "Sub Gerencia de Tesoreria", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 1 },
        { id: 5, nombres: "Sub Gerencia  de Logistica y Control Patrimonial", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 1 }, // Subnodo 1
        { id: 6, nombres: "EF CONTROL PATRIMONIAL", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 5 }, // Subnodo 2
        { id: 7, nombres: "EF PROCESOS ADMINISTRATIVOS DISCIPLINARIOS PAD", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 2 }, // Subnodo 3
        { id: 8, nombres: "EF ALMACEN", gerencia: "GERENCIA DE  ADMINISTRACION", pid: 5 }  // Subnodo 4
    ];
