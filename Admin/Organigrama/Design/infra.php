 ...
 <!-- Contenido de la página -->
    ...
    <div class="container-fluid">
        <div class="text-center mb-4">
            <h3 id="TituloPrimary" class="text-dark">GERENCIA DE INFRAESTRUCTURA Y DESARROLLO URBANO</h3>
        </div>
    </div>
    <div id="arbol"></div>
    </div>
    ...
    var datosEstaticos = [
        ...
        { id: 2, nombres: "Sub Gerencia de Estudios ", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 1 },
        { id: 3, nombres: "Sub Gerencia de Obras y Mantenimiento", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 1 },
        { id: 4, nombres: "Sub Gerencia de Desarrollo Urbano-Rural y Gestion de Riesgos de Desastres", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 1 },
        { id: 5, nombres: "EF PLANEAMIENTO URBANO", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 4 }, // Subnodo 1
        { id: 6, nombres: "EF LICENCIAS", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 4 }, // Subnodo 2
        { id: 7, nombres: "EF GESTION DE RIESGOS Y DESASTRES", gerencia: "GERENCIA DE INFRAESTRUCTURA", pid: 4 }, // Subnodo 2
