 ...
 <!-- Contenido de la página -->
    ...
    <div class="container-fluid">
        <div class="text-center mb-4">
            <h3 id="TituloPrimary" class="text-dark">Alcaldia - Municipalidad CIudad Nueva</h3>
        </div>
    </div>
    <div id="arbol"></div>
    </div>
    ...
    var datosEstaticos = [
        { id: 1, nombres: "Alcaldia", gerencia: "Municipalidad Ciudad Nueva" },
        { id: 2, nombres: "Organo de Control Institucional", gerencia: "Alcaldia", pid: 1 },
        { id: 3, nombres: "Oficina de Procuraduría Publica Municipal", gerencia: "Alcaldia", pid: 1 },
        { id: 4, nombres: "EF ARCHIVO CENTRAL", gerencia: "Alcaldia", pid: 5 },
        { id: 5, nombres: "EF TRAMITE DOCUMENTARIO", gerencia: "Alcaldia", pid: 6 }, // Subnodo 1
        { id: 6, nombres: "EF REGISTRO CIVIL", gerencia: "Alcaldia", pid: 7 }, // Subnodo 2
        { id: 7, nombres: "EF IMAGEN INSTITUCION", gerencia: "Alcaldia", pid: 8 }, // Subnodo 3
        { id: 8, nombres: "Sub Gerencia de  Secretaria General", gerencia: "Subgerencia", pid: 9 }  // Subnodo 4
    ];
